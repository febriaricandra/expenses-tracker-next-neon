    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a1833]">
      <div className="w-full max-w-xs p-6 rounded-2xl bg-[#11224d] shadow-lg">
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-white mb-1">Masuk Akun</h1>
          <p className="text-xs text-gray-300">Belum Memiliki Akun? <a href="/register" className="underline">Buat di sini.</a></p>
        </div>
